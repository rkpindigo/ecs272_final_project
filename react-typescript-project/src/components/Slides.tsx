    ...
    const slides = useMemo(
        () => {
            ...
            },
            {
                ...
                body: "The hashtag became a turning point in public conversation. If it mattered, we should see a break. This comparison tracks race only (People of Color nominees).",
